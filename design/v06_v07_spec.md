...
NOT replicate; winning projection unstable) -> edge DE-RISKED, node NOT; BRANCH ADJUDICATION HELD (retire-node +
relational/edge build vs node-survives). The D2 grid / family-lock / R1-M5 runs stay HELD. Then D3 (FOMC); v0.7.2 R3; the M5 +
