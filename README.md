...
| v0.5.3-v0.5.4 *(planned)* | K₃ (transformer prequential), K₄ (MDL-HMM) — one estimator per sub-version, each adding new cross-proxy pairs to the convergence matrix |
